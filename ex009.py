# Solicita ao usuário que digite um número para gerar a tabuada e armazena na variável t
t = int(input('Digite um número para fazermos a tabuada: '))

# Imprime na tela a tabuada de multiplicação para o número digitado
